...
def visualize_tables(model, resultsdic):
    ...
    count_info_out = {"scenAcount": [resultsdic["Acount"], "AA_count", "AAcount"],
                       "scenBcount": [resultsdic["Bcount"], "BB_count", "BBcount"],
                       "scenCcount": [resultsdic["Ccount"], "CC_count", "CCcount"],
                       "scenDcount": [resultsdic["Dcount"], "DD_count", "DDcount"],
                       "intAcount": [resultsdic["Aintcount"], "AAint_count", "AAintcount"],
                       "intBcount": [resultsdic["Bintcount"], "BBint_count", "BBintcount"],
                       "intCcount": [resultsdic["Cintcount"], "CCint_count", "CCintcount"],
                       "intDcount": [resultsdic["Dintcount"], "DDint_count", "DDintcount"]}
    test_info_out = {"scenAtestcount": [resultsdic["Atestcount"], "AA_testcount", "AAtestcount"],
                    "scenBtestcount": [resultsdic["Btestcount"], "BB_testcount", "BBtestcount"],
                    "scenCtestcount": [resultsdic["Ctestcount"], "CC_testcount", "CCtestcount"],
                    "scenDtestcount": [resultsdic["Dtestcount"], "DD_testcount", "DDtestcount"],
                     "scenAinttestcount": [resultsdic["Atestintcount"], "AA_testintcount", "AAtestintcount"],
                     "scenBinttestcount": [resultsdic["Btestintcount"], "BB_testintcount", "BBtestintcount"],
                     "scenCinttestcount": [resultsdic["Ctestintcount"], "CC_testintcount", "CCtestintcount"],
                     "scenDinttestcount": [resultsdic["Dtestintcount"], "DD_testintcount", "DDtestintcount"]}
