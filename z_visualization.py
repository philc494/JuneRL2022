...
def visualize_tables(model, resultsdic):
    reward_info_out = {"scenA": [resultsdic[model]["A"], "AA_rewards", "AA"],
                       "scenB": [resultsdic[model]["B"], "BB_rewards", "BB"],
    ...
    count_info_out = {"scenAcount": [resultsdic[model]["Acount"], "AA_count", "AAcount"],
                       "scenBcount": [resultsdic[model]["Bcount"], "BB_count", "BBcount"],
                       "scenCcount": [resultsdic[model]["Ccount"], "CC_count", "CCcount"],
                       "scenDcount": [resultsdic[model]["Dcount"], "DD_count", "DDcount"],
                       "intAcount": [resultsdic[model]["Aintcount"], "AAint_count", "AAintcount"],
                       "intBcount": [resultsdic[model]["Bintcount"], "BBint_count", "BBintcount"],
                       "intCcount": [resultsdic[model]["Cintcount"], "CCint_count", "CCintcount"],
                       "intDcount": [resultsdic[model]["Dintcount"], "DDint_count", "DDintcount"]}
    test_info_out = {"scenAtestcount": [resultsdic[model]["Atestcount"], "AA_testcount", "AAtestcount"],
                    "scenBtestcount": [resultsdic[model]["Btestcount"], "BB_testcount", "BBtestcount"],
                    "scenCtestcount": [resultsdic[model]["Ctestcount"], "CC_testcount", "CCtestcount"],
                    "scenDtestcount": [resultsdic[model]["Dtestcount"], "DD_testcount", "DDtestcount"],
                     "scenAinttestcount": [resultsdic[model]["Atestintcount"], "AA_testintcount", "AAtestintcount"],
                     "scenBinttestcount": [resultsdic[model]["Btestintcount"], "BB_testintcount", "BBtestintcount"],
                     "scenCinttestcount": [resultsdic[model]["Ctestintcount"], "CC_testintcount", "CCtestintcount"],
                     "scenDinttestcount": [resultsdic[model]["Dtestintcount"], "DD_testintcount", "DDtestintcount"]}
    ...
    for a in reward_info_out:
        ...
        directory = str(model)
        parent_dir = '/Users/philcrawford/PycharmProjects/JuneRL2022/results/train'
    ...
    for a in count_info_out:
        dic_value_list = []
        for b in count_info_out[a][0]:
            for c in count_info_out[a][0][b]:
                dic_value_list.append(count_info_out[a][0][b][c])
        min_val = min(dic_value_list)
        max_val = max(dic_value_list)
        dic00 = minisquare_values(count_info_out[a][0], (0, 0))
        v00_n1n1 = dic00[(-1, -1)]
        v00_n10 = dic00[(-1, 0)]
        v00_n11 = dic00[(-1, 1)]
        v00_0n1 = dic00[(0, -1)]
        ...
        v00_10 = dic00[(1, 0)]
        v00_11 = dic00[(1, 1)]
        dic01 = minisquare_values(count_info_out[a][0], (0, 1))
        v01_n1n1 = dic01[(-1, -1)]
        v01_n10 = dic01[(-1, 0)]
        v01_n11 = dic01[(-1, 1)]
        v01_0n1 = dic01[(0, -1)]
        ...
        v01_10 = dic01[(1, 0)]
        v01_11 = dic01[(1, 1)]
        dic02 = minisquare_values(count_info_out[a][0], (0, 2))
        v02_n1n1 = dic02[(-1, -1)]
        v02_n10 = dic02[(-1, 0)]
        v02_n11 = dic02[(-1, 1)]
        v02_0n1 = dic02[(0, -1)]
        ...
        v02_10 = dic02[(1, 0)]
        v02_11 = dic02[(1, 1)]
        dic03 = minisquare_values(count_info_out[a][0], (0, 3))
        v03_n1n1 = dic03[(-1, -1)]
        v03_n10 = dic03[(-1, 0)]
        v03_n11 = dic03[(-1, 1)]
        v03_0n1 = dic03[(0, -1)]
        ...
        v03_10 = dic03[(1, 0)]
        v03_11 = dic03[(1, 1)]
        dic04 = minisquare_values(count_info_out[a][0], (0, 4))
        v04_n1n1 = dic04[(-1, -1)]
        v04_n10 = dic04[(-1, 0)]
        v04_n11 = dic04[(-1, 1)]
        v04_0n1 = dic04[(0, -1)]
        ...
        v04_10 = dic04[(1, 0)]
        v04_11 = dic04[(1, 1)]
        dic10 = minisquare_values(count_info_out[a][0], (1, 0))
        v10_n1n1 = dic10[(-1, -1)]
        v10_n10 = dic10[(-1, 0)]
        v10_n11 = dic10[(-1, 1)]
        v10_0n1 = dic10[(0, -1)]
        ...
        v10_10 = dic10[(1, 0)]
        v10_11 = dic10[(1, 1)]
        dic11 = minisquare_values(count_info_out[a][0], (1, 1))
        v11_n1n1 = dic11[(-1, -1)]
        v11_n10 = dic11[(-1, 0)]
        v11_n11 = dic11[(-1, 1)]
        v11_0n1 = dic11[(0, -1)]
        ...
        v11_10 = dic11[(1, 0)]
        v11_11 = dic11[(1, 1)]
        dic12 = minisquare_values(count_info_out[a][0], (1, 2))
        v12_n1n1 = dic12[(-1, -1)]
        v12_n10 = dic12[(-1, 0)]
        v12_n11 = dic12[(-1, 1)]
        v12_0n1 = dic12[(0, -1)]
        ...
        v12_10 = dic12[(1, 0)]
        v12_11 = dic12[(1, 1)]
        dic13 = minisquare_values(count_info_out[a][0], (1, 3))
        v13_n1n1 = dic13[(-1, -1)]
        v13_n10 = dic13[(-1, 0)]
        v13_n11 = dic13[(-1, 1)]
        v13_0n1 = dic13[(0, -1)]
        ...
        v13_10 = dic13[(1, 0)]
        v13_11 = dic13[(1, 1)]
        dic14 = minisquare_values(count_info_out[a][0], (1, 4))
        v14_n1n1 = dic14[(-1, -1)]
        v14_n10 = dic14[(-1, 0)]
        v14_n11 = dic14[(-1, 1)]
        v14_0n1 = dic14[(0, -1)]
        ...
        v14_10 = dic14[(1, 0)]
        v14_11 = dic14[(1, 1)]
        dic20 = minisquare_values(count_info_out[a][0], (2, 0))
        v20_n1n1 = dic20[(-1, -1)]
        v20_n10 = dic20[(-1, 0)]
        v20_n11 = dic20[(-1, 1)]
        v20_0n1 = dic20[(0, -1)]
        ...
        v20_10 = dic20[(1, 0)]
        v20_11 = dic20[(1, 1)]
        dic21 = minisquare_values(count_info_out[a][0], (2, 1))
        v21_n1n1 = dic21[(-1, -1)]
        v21_n10 = dic21[(-1, 0)]
        v21_n11 = dic21[(-1, 1)]
        v21_0n1 = dic21[(0, -1)]
        ...
        v21_10 = dic21[(1, 0)]
        v21_11 = dic21[(1, 1)]
        dic22 = minisquare_values(count_info_out[a][0], (2, 2))
        v22_n1n1 = dic22[(-1, -1)]
        v22_n10 = dic22[(-1, 0)]
        v22_n11 = dic22[(-1, 1)]
        v22_0n1 = dic22[(0, -1)]
        ...
        v22_10 = dic22[(1, 0)]
        v22_11 = dic22[(1, 1)]
        dic23 = minisquare_values(count_info_out[a][0], (2, 3))
        v23_n1n1 = dic23[(-1, -1)]
        v23_n10 = dic23[(-1, 0)]
        v23_n11 = dic23[(-1, 1)]
        v23_0n1 = dic23[(0, -1)]
        ...
        v23_10 = dic23[(1, 0)]
        v23_11 = dic23[(1, 1)]
        dic24 = minisquare_values(count_info_out[a][0], (2, 4))
        v24_n1n1 = dic24[(-1, -1)]
        v24_n10 = dic24[(-1, 0)]
        v24_n11 = dic24[(-1, 1)]
        v24_0n1 = dic24[(0, -1)]
        ...
        v24_10 = dic24[(1, 0)]
        v24_11 = dic24[(1, 1)]
        dic30 = minisquare_values(count_info_out[a][0], (3, 0))
        v30_n1n1 = dic30[(-1, -1)]
        v30_n10 = dic30[(-1, 0)]
        v30_n11 = dic30[(-1, 1)]
        v30_0n1 = dic30[(0, -1)]
        ...
        v30_10 = dic30[(1, 0)]
        v30_11 = dic30[(1, 1)]
        dic31 = minisquare_values(count_info_out[a][0], (3, 1))
        v31_n1n1 = dic31[(-1, -1)]
        v31_n10 = dic31[(-1, 0)]
        v31_n11 = dic31[(-1, 1)]
        v31_0n1 = dic31[(0, -1)]
        ...
        v31_10 = dic31[(1, 0)]
        v31_11 = dic31[(1, 1)]
        dic32 = minisquare_values(count_info_out[a][0], (3, 2))
        v32_n1n1 = dic32[(-1, -1)]
        v32_n10 = dic32[(-1, 0)]
        v32_n11 = dic32[(-1, 1)]
        v32_0n1 = dic32[(0, -1)]
        ...
        v32_10 = dic32[(1, 0)]
        v32_11 = dic32[(1, 1)]
        dic33 = minisquare_values(count_info_out[a][0], (3, 3))
        v33_n1n1 = dic33[(-1, -1)]
        v33_n10 = dic33[(-1, 0)]
        v33_n11 = dic33[(-1, 1)]
        v33_0n1 = dic33[(0, -1)]
        ...
        v33_10 = dic33[(1, 0)]
        v33_11 = dic33[(1, 1)]
        dic34 = minisquare_values(count_info_out[a][0], (3, 4))
        v34_n1n1 = dic34[(-1, -1)]
        v34_n10 = dic34[(-1, 0)]
        v34_n11 = dic34[(-1, 1)]
        v34_0n1 = dic34[(0, -1)]
        ...
        v34_10 = dic34[(1, 0)]
        v34_11 = dic34[(1, 1)]
        dic40 = minisquare_values(count_info_out[a][0], (4, 0))
        v40_n1n1 = dic40[(-1, -1)]
        v40_n10 = dic40[(-1, 0)]
        v40_n11 = dic40[(-1, 1)]
        v40_0n1 = dic40[(0, -1)]
        ...
        v40_10 = dic40[(1, 0)]
        v40_11 = dic40[(1, 1)]
        dic41 = minisquare_values(count_info_out[a][0], (4, 1))
        v41_n1n1 = dic41[(-1, -1)]
        v41_n10 = dic41[(-1, 0)]
        v41_n11 = dic41[(-1, 1)]
        v41_0n1 = dic41[(0, -1)]
        ...
        v41_10 = dic41[(1, 0)]
        v41_11 = dic41[(1, 1)]
        dic42 = minisquare_values(count_info_out[a][0], (4, 2))
        v42_n1n1 = dic42[(-1, -1)]
        v42_n10 = dic42[(-1, 0)]
        v42_n11 = dic42[(-1, 1)]
        v42_0n1 = dic42[(0, -1)]
        ...
        v42_10 = dic42[(1, 0)]
        v42_11 = dic42[(1, 1)]
        dic43 = minisquare_values(count_info_out[a][0], (4, 3))
        v43_n1n1 = dic43[(-1, -1)]
        v43_n10 = dic43[(-1, 0)]
        v43_n11 = dic43[(-1, 1)]
        v43_0n1 = dic43[(0, -1)]
        ...
        v43_10 = dic43[(1, 0)]
        v43_11 = dic43[(1, 1)]
        dic44 = minisquare_values(count_info_out[a][0], (4, 4))
        v44_n1n1 = dic44[(-1, -1)]
        v44_n10 = dic44[(-1, 0)]
        v44_n11 = dic44[(-1, 1)]
        v44_0n1 = dic44[(0, -1)]
        ...
        if not path:
            os.mkdir(path)
        # writer = pd.ExcelWriter(path + '/' + str(model) + '_' + count_info_out[a][1] + '.xlsx', engine='xlsxwriter')
        # pivot00.to_excel(writer, sheet_name=count_info_out[a][2] + '00')
        # pivot01.to_excel(writer, sheet_name=count_info_out[a][2] + '01')
        # pivot02.to_excel(writer, sheet_name=count_info_out[a][2] + '02')
        # pivot03.to_excel(writer, sheet_name=count_info_out[a][2] + '03')
        # pivot04.to_excel(writer, sheet_name=count_info_out[a][2] + '04')
        # pivot10.to_excel(writer, sheet_name=count_info_out[a][2] + '10')
        # pivot11.to_excel(writer, sheet_name=count_info_out[a][2] + '11')
        # pivot12.to_excel(writer, sheet_name=count_info_out[a][2] + '12')
        # pivot13.to_excel(writer, sheet_name=count_info_out[a][2] + '13')
        # pivot14.to_excel(writer, sheet_name=count_info_out[a][2] + '14')
        # pivot20.to_excel(writer, sheet_name=count_info_out[a][2] + '20')
        # pivot21.to_excel(writer, sheet_name=count_info_out[a][2] + '21')
        # pivot22.to_excel(writer, sheet_name=count_info_out[a][2] + '22')
        # pivot23.to_excel(writer, sheet_name=count_info_out[a][2] + '23')
        # pivot24.to_excel(writer, sheet_name=count_info_out[a][2] + '24')
        # pivot30.to_excel(writer, sheet_name=count_info_out[a][2] + '30')
        # pivot31.to_excel(writer, sheet_name=count_info_out[a][2] + '31')
        # pivot32.to_excel(writer, sheet_name=count_info_out[a][2] + '32')
        # pivot33.to_excel(writer, sheet_name=count_info_out[a][2] + '33')
        # pivot34.to_excel(writer, sheet_name=count_info_out[a][2] + '34')
        # pivot40.to_excel(writer, sheet_name=count_info_out[a][2] + '40')
        # pivot41.to_excel(writer, sheet_name=count_info_out[a][2] + '41')
        # pivot42.to_excel(writer, sheet_name=count_info_out[a][2] + '42')
        # pivot43.to_excel(writer, sheet_name=count_info_out[a][2] + '43')
        # pivot44.to_excel(writer, sheet_name=count_info_out[a][2] + '44')
        # writer.save()
        ...
        fig.tight_layout(rect=[0, 0, .9, 1])
        fig.savefig(path + '/' + str(model) + '_' + count_info_out[a][2] + "_fullgrid.png")
        plt.close()

    for a in test_info_out:
        dic00 = minisquare_values(test_info_out[a][0], (0, 0))
        v00_n1n1 = dic00[(-1, -1)]
        v00_n10 = dic00[(-1, 0)]
        v00_n11 = dic00[(-1, 1)]
        v00_0n1 = dic00[(0, -1)]
        ...
        v00_10 = dic00[(1, 0)]
        v00_11 = dic00[(1, 1)]
        dic01 = minisquare_values(test_info_out[a][0], (0, 1))
        v01_n1n1 = dic01[(-1, -1)]
        v01_n10 = dic01[(-1, 0)]
        v01_n11 = dic01[(-1, 1)]
        v01_0n1 = dic01[(0, -1)]
        ...
        v01_10 = dic01[(1, 0)]
        v01_11 = dic01[(1, 1)]
        dic02 = minisquare_values(test_info_out[a][0], (0, 2))
        v02_n1n1 = dic02[(-1, -1)]
        v02_n10 = dic02[(-1, 0)]
        v02_n11 = dic02[(-1, 1)]
        v02_0n1 = dic02[(0, -1)]
        ...
        v02_10 = dic02[(1, 0)]
        v02_11 = dic02[(1, 1)]
        dic03 = minisquare_values(test_info_out[a][0], (0, 3))
        v03_n1n1 = dic03[(-1, -1)]
        v03_n10 = dic03[(-1, 0)]
        v03_n11 = dic03[(-1, 1)]
        v03_0n1 = dic03[(0, -1)]
        ...
        v03_10 = dic03[(1, 0)]
        v03_11 = dic03[(1, 1)]
        dic04 = minisquare_values(test_info_out[a][0], (0, 4))
        v04_n1n1 = dic04[(-1, -1)]
        v04_n10 = dic04[(-1, 0)]
        v04_n11 = dic04[(-1, 1)]
        v04_0n1 = dic04[(0, -1)]
        ...
        v04_10 = dic04[(1, 0)]
        v04_11 = dic04[(1, 1)]
        dic10 = minisquare_values(test_info_out[a][0], (1, 0))
        v10_n1n1 = dic10[(-1, -1)]
        v10_n10 = dic10[(-1, 0)]
        v10_n11 = dic10[(-1, 1)]
        v10_0n1 = dic10[(0, -1)]
        ...
        v10_10 = dic10[(1, 0)]
        v10_11 = dic10[(1, 1)]
        dic11 = minisquare_values(test_info_out[a][0], (1, 1))
        v11_n1n1 = dic11[(-1, -1)]
        v11_n10 = dic11[(-1, 0)]
        v11_n11 = dic11[(-1, 1)]
        v11_0n1 = dic11[(0, -1)]
        ...
        v11_10 = dic11[(1, 0)]
        v11_11 = dic11[(1, 1)]
        dic12 = minisquare_values(test_info_out[a][0], (1, 2))
        v12_n1n1 = dic12[(-1, -1)]
        v12_n10 = dic12[(-1, 0)]
        v12_n11 = dic12[(-1, 1)]
        v12_0n1 = dic12[(0, -1)]
        ...
        v12_10 = dic12[(1, 0)]
        v12_11 = dic12[(1, 1)]
        dic13 = minisquare_values(test_info_out[a][0], (1, 3))
        v13_n1n1 = dic13[(-1, -1)]
        v13_n10 = dic13[(-1, 0)]
        v13_n11 = dic13[(-1, 1)]
        v13_0n1 = dic13[(0, -1)]
        ...
        v13_10 = dic13[(1, 0)]
        v13_11 = dic13[(1, 1)]
        dic14 = minisquare_values(test_info_out[a][0], (1, 4))
        v14_n1n1 = dic14[(-1, -1)]
        v14_n10 = dic14[(-1, 0)]
        v14_n11 = dic14[(-1, 1)]
        v14_0n1 = dic14[(0, -1)]
        ...
        v14_10 = dic14[(1, 0)]
        v14_11 = dic14[(1, 1)]
        dic20 = minisquare_values(test_info_out[a][0], (2, 0))
        v20_n1n1 = dic20[(-1, -1)]
        v20_n10 = dic20[(-1, 0)]
        v20_n11 = dic20[(-1, 1)]
        v20_0n1 = dic20[(0, -1)]
        ...
        v20_10 = dic20[(1, 0)]
        v20_11 = dic20[(1, 1)]
        dic21 = minisquare_values(test_info_out[a][0], (2, 1))
        v21_n1n1 = dic21[(-1, -1)]
        v21_n10 = dic21[(-1, 0)]
        v21_n11 = dic21[(-1, 1)]
        v21_0n1 = dic21[(0, -1)]
        ...
        v21_10 = dic21[(1, 0)]
        v21_11 = dic21[(1, 1)]
        dic22 = minisquare_values(test_info_out[a][0], (2, 2))
        v22_n1n1 = dic22[(-1, -1)]
        v22_n10 = dic22[(-1, 0)]
        v22_n11 = dic22[(-1, 1)]
        v22_0n1 = dic22[(0, -1)]
        ...
        v22_10 = dic22[(1, 0)]
        v22_11 = dic22[(1, 1)]
        dic23 = minisquare_values(test_info_out[a][0], (2, 3))
        v23_n1n1 = dic23[(-1, -1)]
        v23_n10 = dic23[(-1, 0)]
        v23_n11 = dic23[(-1, 1)]
        v23_0n1 = dic23[(0, -1)]
        ...
        v23_10 = dic23[(1, 0)]
        v23_11 = dic23[(1, 1)]
        dic24 = minisquare_values(test_info_out[a][0], (2, 4))
        v24_n1n1 = dic24[(-1, -1)]
        v24_n10 = dic24[(-1, 0)]
        v24_n11 = dic24[(-1, 1)]
        v24_0n1 = dic24[(0, -1)]
        ...
        v24_10 = dic24[(1, 0)]
        v24_11 = dic24[(1, 1)]
        dic30 = minisquare_values(test_info_out[a][0], (3, 0))
        v30_n1n1 = dic30[(-1, -1)]
        v30_n10 = dic30[(-1, 0)]
        v30_n11 = dic30[(-1, 1)]
        v30_0n1 = dic30[(0, -1)]
        ...
        v30_10 = dic30[(1, 0)]
        v30_11 = dic30[(1, 1)]
        dic31 = minisquare_values(test_info_out[a][0], (3, 1))
        v31_n1n1 = dic31[(-1, -1)]
        v31_n10 = dic31[(-1, 0)]
        v31_n11 = dic31[(-1, 1)]
        v31_0n1 = dic31[(0, -1)]
        ...
        v31_10 = dic31[(1, 0)]
        v31_11 = dic31[(1, 1)]
        dic32 = minisquare_values(test_info_out[a][0], (3, 2))
        v32_n1n1 = dic32[(-1, -1)]
        v32_n10 = dic32[(-1, 0)]
        v32_n11 = dic32[(-1, 1)]
        v32_0n1 = dic32[(0, -1)]
        ...
        v32_10 = dic32[(1, 0)]
        v32_11 = dic32[(1, 1)]
        dic33 = minisquare_values(test_info_out[a][0], (3, 3))
        v33_n1n1 = dic33[(-1, -1)]
        v33_n10 = dic33[(-1, 0)]
        v33_n11 = dic33[(-1, 1)]
        v33_0n1 = dic33[(0, -1)]
        ...
        v33_10 = dic33[(1, 0)]
        v33_11 = dic33[(1, 1)]
        dic34 = minisquare_values(test_info_out[a][0], (3, 4))
        v34_n1n1 = dic34[(-1, -1)]
        v34_n10 = dic34[(-1, 0)]
        v34_n11 = dic34[(-1, 1)]
        v34_0n1 = dic34[(0, -1)]
        ...
        v34_10 = dic34[(1, 0)]
        v34_11 = dic34[(1, 1)]
        dic40 = minisquare_values(test_info_out[a][0], (4, 0))
        v40_n1n1 = dic40[(-1, -1)]
        v40_n10 = dic40[(-1, 0)]
        v40_n11 = dic40[(-1, 1)]
        v40_0n1 = dic40[(0, -1)]
        ...
        v40_10 = dic40[(1, 0)]
        v40_11 = dic40[(1, 1)]
        dic41 = minisquare_values(test_info_out[a][0], (4, 1))
        v41_n1n1 = dic41[(-1, -1)]
        v41_n10 = dic41[(-1, 0)]
        v41_n11 = dic41[(-1, 1)]
        v41_0n1 = dic41[(0, -1)]
        ...
        v41_10 = dic41[(1, 0)]
        v41_11 = dic41[(1, 1)]
        dic42 = minisquare_values(test_info_out[a][0], (4, 2))
        v42_n1n1 = dic42[(-1, -1)]
        v42_n10 = dic42[(-1, 0)]
        v42_n11 = dic42[(-1, 1)]
        v42_0n1 = dic42[(0, -1)]
        ...
        v42_10 = dic42[(1, 0)]
        v42_11 = dic42[(1, 1)]
        dic43 = minisquare_values(test_info_out[a][0], (4, 3))
        v43_n1n1 = dic43[(-1, -1)]
        v43_n10 = dic43[(-1, 0)]
        v43_n11 = dic43[(-1, 1)]
        v43_0n1 = dic43[(0, -1)]
        ...
        v43_10 = dic43[(1, 0)]
        v43_11 = dic43[(1, 1)]
        dic44 = minisquare_values(test_info_out[a][0], (4, 4))
        v44_n1n1 = dic44[(-1, -1)]
        v44_n10 = dic44[(-1, 0)]
        v44_n11 = dic44[(-1, 1)]
        v44_0n1 = dic44[(0, -1)]
        ...
        if not path:
            os.mkdir(path)
        # writer = pd.ExcelWriter(path + '/' + str(model) + '_' + test_info_out[a][1] + '.xlsx', engine='xlsxwriter')
        # pivot00.to_excel(writer, sheet_name=test_info_out[a][2] + '00')
        # pivot01.to_excel(writer, sheet_name=test_info_out[a][2] + '01')
        # pivot02.to_excel(writer, sheet_name=test_info_out[a][2] + '02')
        # pivot03.to_excel(writer, sheet_name=test_info_out[a][2] + '03')
        # pivot04.to_excel(writer, sheet_name=test_info_out[a][2] + '04')
        # pivot10.to_excel(writer, sheet_name=test_info_out[a][2] + '10')
        # pivot11.to_excel(writer, sheet_name=test_info_out[a][2] + '11')
        # pivot12.to_excel(writer, sheet_name=test_info_out[a][2] + '12')
        # pivot13.to_excel(writer, sheet_name=test_info_out[a][2] + '13')
        # pivot14.to_excel(writer, sheet_name=test_info_out[a][2] + '14')
        # pivot20.to_excel(writer, sheet_name=test_info_out[a][2] + '20')
        # pivot21.to_excel(writer, sheet_name=test_info_out[a][2] + '21')
        # pivot22.to_excel(writer, sheet_name=test_info_out[a][2] + '22')
        # pivot23.to_excel(writer, sheet_name=test_info_out[a][2] + '23')
        # pivot24.to_excel(writer, sheet_name=test_info_out[a][2] + '24')
        # pivot30.to_excel(writer, sheet_name=test_info_out[a][2] + '30')
        # pivot31.to_excel(writer, sheet_name=test_info_out[a][2] + '31')
        # pivot32.to_excel(writer, sheet_name=test_info_out[a][2] + '32')
        # pivot33.to_excel(writer, sheet_name=test_info_out[a][2] + '33')
        # pivot34.to_excel(writer, sheet_name=test_info_out[a][2] + '34')
        # pivot40.to_excel(writer, sheet_name=test_info_out[a][2] + '40')
        # pivot41.to_excel(writer, sheet_name=test_info_out[a][2] + '41')
        # pivot42.to_excel(writer, sheet_name=test_info_out[a][2] + '42')
        # pivot43.to_excel(writer, sheet_name=test_info_out[a][2] + '43')
        # pivot44.to_excel(writer, sheet_name=test_info_out[a][2] + '44')
        # writer.save()
        ...
        ax = plt.subplot(5, 5, 1)
        sns.heatmap(pivot00, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 2)
        sns.heatmap(pivot01, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 3)
        sns.heatmap(pivot02, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 4)
        sns.heatmap(pivot03, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 5)
        sns.heatmap(pivot04, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 6)
        sns.heatmap(pivot10, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 7)
        sns.heatmap(pivot11, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 8)
        sns.heatmap(pivot12, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 9)
        sns.heatmap(pivot13, annot=True, fmt="g", cmap='vlag',cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 10)
        sns.heatmap(pivot14, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 11)
        sns.heatmap(pivot20, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 12)
        sns.heatmap(pivot21, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 13)
        sns.heatmap(pivot22, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 14)
        sns.heatmap(pivot23, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 15)
        sns.heatmap(pivot24, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 16)
        sns.heatmap(pivot30, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 17)
        sns.heatmap(pivot31, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 18)
        sns.heatmap(pivot32, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 19)
        sns.heatmap(pivot33, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 20)
        sns.heatmap(pivot34, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 21)
        sns.heatmap(pivot40, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 22)
        sns.heatmap(pivot41, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 23)
        sns.heatmap(pivot42, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 24)
        sns.heatmap(pivot43, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        ax = plt.subplot(5, 5, 25)
        sns.heatmap(pivot44, annot=True, fmt="g", cmap='vlag', cbar=False, ax=ax)
        ax.set_aspect('equal')

        fig.tight_layout(rect=[0, 0, .9, 1])
        fig.savefig(path + '/' + str(model) + '_' + test_info_out[a][2] + "_fullgrid.png")